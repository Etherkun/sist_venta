<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-delete-{{$ven->id_venta}}">
	{{Form::Open(array('action'=>array('App\Http\Controllers\VentaController@destroy',$ven->id_venta),'method'=>'delete'))}}
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Eliminar Registro de Venta</h4>
			</div>
